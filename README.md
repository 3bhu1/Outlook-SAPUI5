...
Replace the `YOUR APP ID HERE` and `redirectUri` value in `index.html` with the application ID and redirect url you generated as part of the app registration process.
